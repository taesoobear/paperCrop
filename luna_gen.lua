...
do -- user configurations : all these can be changed in input file or from command line argument.
	...
	'^include$', '^headerFile$','^decl$','^if_$', '^enums$','^inheritsFrom$', '^name$','^className$','^ctors$','^wrapperCode$',
...
do -- utility functions
	...
	function writeIncludeBlock(include_luna)
		write([[
		#include <stdio.h>
		#include <string.h>
		#include <string>
...
function writeDefinitions(bindTarget, bindfunc_name, customScript)
	...
	for iluaclass, luaclass in ipairs(bindTarget.classes) do
		...
		elseif luaclass.include then
			addLine(luaclass.include)
		end
